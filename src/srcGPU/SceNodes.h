...
typedef thrust::tuple<double, double, double, double, double, uint, uint, uint> CVec5UUU;
typedef thrust::tuple<double, double, double, double> CVec4;
typedef thrust::tuple<double, double, double, double, int> CVec4Int;
...
// only for modified version
	...
	thrust::device_vector<double> fluxWeightsFollower;
...
class SceNodes {
	...
	void allocSpaceForNodes(uint maxTotalNodeCount, uint maxIntnlNodeCountPerCell, uint maxCellCount);
	/**
